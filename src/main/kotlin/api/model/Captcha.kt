...
data class Captcha(
    ...
    private fun initAddFields() {
        ...
        returnPath = if (retPathMatch != null) {
            ...
            throw IllegalStateException("api.model.Captcha does not contain return path in captcha page link")
        }
    ...
    fun sendCaptcha(
        ...
        GlobalScope.launch(Dispatchers.IO) {
            sendCaptcha(value, getJson = false)?.let { stringBody ->
                if (stringBody.contains("captcha")) {  // TODO mapper from ResponseBody to api.model.Captcha
